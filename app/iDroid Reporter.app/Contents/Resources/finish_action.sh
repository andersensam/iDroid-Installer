...
# Introductory text
tb.type = text
tb.default = A ZIP with the error report has been generated and is stored in your Home folder. Please upload this file to the AndersenTech iDroid Reporter Website. The username is 'idroid' and the password is 'errorreport' Thank you for using iDroid Installer!
...
open http://www.andersentechwiki.net/idroid_error_report
